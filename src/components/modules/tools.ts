...
import MarkDescriptionInlineTool from "../inline-tools/inline-tool-mark-description";
...
export default class Tools extends Module {
  ...
  private get internalTools(): {
    ...
    return {
      ...
      markDescription: { class: MarkDescriptionInlineTool },
      paragraph: {
        class: Paragraph,
        inlineToolbar: true,
        isInternal: true,
   ...
   */
  private getListOfPrepareFunctions(config: {
    [name: string]: ToolSettings;
  }): {
